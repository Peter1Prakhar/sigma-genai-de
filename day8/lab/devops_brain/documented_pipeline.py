...
access_key = "AKIAIOSFODNN7EXAMPLE"  # BUG: Hardcoded AWS credentials
secret_key = "wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY"  # BUG: Hardcoded AWS credentials
region = "us-east-1"
...
def transform_bronze_to_silver(transactions: list, merchants: list) -> list:
    """
    Transforms bronze transactions to silver format.

    Args:
        transactions: List of bronze transaction records.
        merchants: List of merchant records.

    Returns:
        List of transformed silver transaction records.
    """
...
def load_silver(con: duckdb.DuckDBPyConnection, silver_rows: list) -> None:
    ...
    Args:
        con: The database connection.
        silver_rows: List of silver transaction records.
    """
...
def compute_merchant_performance(silver_rows: list) -> list:
    ...
    Returns:
        List of merchant performance metrics.
    """
    from collections import defaultdict
...
def load_gold(con: duckdb.DuckDBPyConnection, merchant_perf: list, daily_summary: list) -> None:
    ...
    Args:
        con: The database connection.
        merchant_perf: List of merchant performance metrics.
        daily_summary: List of daily summary metrics.
    """
